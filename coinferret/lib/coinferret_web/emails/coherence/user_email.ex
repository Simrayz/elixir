...
defmodule CoinferretWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: CoinferretWeb.Coherence.EmailView, layout: {CoinferretWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
